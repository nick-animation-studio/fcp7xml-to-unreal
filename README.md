...
Edit a sequence from Unreal Engine in your preferred editing software and import the edits back into Unreal Engine, without crashing. **Only FCP 7 XML v5 is supported.**
